...
metadata {
  definition(name: "Ecowitt RF Sensor", namespace: "mircolino", author: "Simon Burke", importUrl: "https://raw.githubusercontent.com/${gitHubUser}/${gitHubRepo}/main/ecowitt_sensor.groovy") {
    capability "Sensor";
...
private Object htmlGetRepository() {
  ...
  try {
    String repositoryText = "https://${gitHubUser}.github.io/${gitHubRepo}/ecowitt.json".toURL().getText();
    if (repositoryText) {
      // text -> json
